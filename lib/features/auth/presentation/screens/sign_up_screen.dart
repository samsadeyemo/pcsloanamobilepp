...
//   if (next.accountCreated && prev?.accountCreated != true) {
...
//                             );
//                             // success navigation handled by state
//                           }
//                         },
...
class _SignUpScren extends ConsumerState<SignUpScreen> {
  ...
  //   // listen for state changes (errors, navigation, employeeData updates)
  //   ref.listen<SignupState>(signupProvider, (prev, next) {
  //     // handle errors
  //     if (next.error != null && next.error!.isNotEmpty) {
  //       ScaffoldMessenger.of(context).showSnackBar(
  ...
  //     // update form fields only when employeeData changes
  //     if (next.employeeData != null && next.employeeData != prev?.employeeData) {
  //       _firstNameController.text = next.employeeData!['firstname'] ?? '';
  //       _lastNameController.text = next.employeeData!['lastname'] ?? '';
  //       _phoneController.text = next.employeeData!['phone'] ?? '';
  //       _emailController.text = next.employeeData!['email'] ?? '';
  //       _bvnController.text = next.employeeData!['bvn'] ?? '';
  //     }
  //   });
  // }
...
void initState() {
  ...
  // 👇 correct way in ConsumerStatefulWidget
  ref.listenManual<SignupState>(
    signupProvider,
    (prev, next) {
      if (next.error != null && next.error!.isNotEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
